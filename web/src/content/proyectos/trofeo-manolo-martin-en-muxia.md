...
entrega: Reportaje del triangular
titular: |-
  LO MEJOR
  NO ESTABA
  EN EL CÉSPED.
reto: >-
  Un triangular de pretemporada no tiene nada en juego: ni título, ni tensión en
  la grada, ni consecuencias. El riesgo era volver con fotos correctas de un
  partido que no le importaba a nadie.

  Había que encontrar dónde estaba la historia cuando el marcador da igual.
idea: >-
  Estaba en el sitio. El campo de A Arliña, en plena Costa da Morte, tiene un
  entorno que se come al partido: en cuanto abres el plano, el fútbol pasa a
  segundo término y aparece el paisaje.

  Así que fotografié tanto el entorno como el juego, y busqué los encuadres abiertos que en un estadio grande no existen.
ejecucion:
  - RECONOCER EL CAMPO Y EL ENTORNO
  - CUBRIR LOS TRES EQUIPOS
  - BUSCAR LOS PLANOS ABIERTOS
  - ESTAR EN LA ENTREGA DEL TROFEO
  - SELECCIÓN Y ENTREGA
color: azul
localidad: Muxía
descripcion_seo: >-
  XLIII Trofeo Manolo Martín en Muxía: triangular de pretemporada entre Muxía
  CF, Bergantiños y el filial del Pontevedra, en el campo de A Arliña.
  Reportaje fotográfico por Kiko Lareo, fotógrafo deportivo en A Coruña.
galeria: []
---
